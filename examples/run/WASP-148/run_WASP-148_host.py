...
def create_pastis_file(commentstr):
    ...
    fp1dict = {'P': [8.803611, 2, 'Normal', 8.803611, 0.014, 0.0, 0.0, ''],
                   ## Exoplanets.org (error x 10)
            'T0': [53133.0505, 1, 'Normal', 53133.0505, 0.015,
    ...
    sophiedict = {'RVoffset': [0.0, 0, 'Uniform', 4.0, 6.0, 0.0, 0.0, ''],
                  'RVjitter': [0.01, 1, 'Uniform', 0.0, 0.120, 0.0, 0.0, '']
                 }

    sophiepdict = {'RVoffset': [0.0, 1, 'Normal', 0.0, 0.05, 0.0, 0.0, ''],
                   'RVjitter': [0.01, 1, 'Uniform', 0.0, 0.120, 0.0, 0.0, '']
                  }
